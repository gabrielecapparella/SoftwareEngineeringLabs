 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://lab1_bank.polpetta.it/", wsdlLocation = "http://localhost:8080/Lab1_Bank/BankImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKIMPLSERVICE_QNAME = new QName("http://lab1_bank.polpetta.it/", "BankImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Lab1_Bank/BankImplService?wsdl");
    ...
    public BankIFace getBankImplPort() {
        return super.getPort(new QName("http://lab1_bank.polpetta.it/", "BankImplPort"), BankIFace.class);
    }
    ...
    public BankIFace getBankImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1_bank.polpetta.it/", "BankImplPort"), BankIFace.class, features);
    }
