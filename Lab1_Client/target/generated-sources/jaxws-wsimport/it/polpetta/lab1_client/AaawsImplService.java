 ...
 * 
 */
@WebServiceClient(name = "AaawsImplService", targetNamespace = "http://lab1_aaaws.polpetta.it/", wsdlLocation = "http://localhost:8080/Lab1_AAAWS/AaawsImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName AAAWSIMPLSERVICE_QNAME = new QName("http://lab1_aaaws.polpetta.it/", "AaawsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Lab1_AAAWS/AaawsImplService?wsdl");
    ...
    public AaawsIFace getAaawsImplPort() {
        return super.getPort(new QName("http://lab1_aaaws.polpetta.it/", "AaawsImplPort"), AaawsIFace.class);
    }
    ...
    public AaawsIFace getAaawsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1_aaaws.polpetta.it/", "AaawsImplPort"), AaawsIFace.class, features);
    }
